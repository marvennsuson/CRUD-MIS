...
<div class="content">
    <div class="container-fluid">
      <form enctype="multipart/form-data" id="Updateprofile" method="POST">
        @csrf
        @method('PUT')
                ...
                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                  ...
                  <div>
                    <span class="btn btn-round btn-rose btn-file">
                      ...
                      <input id="useravatar" type="file" name="useravatar" />
                    </span>
                    <br />
            ...
            <div class="card-body">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-6">
                    <h4 class="font-">
                      {{Auth::guard('resident')->user()->firstname . ' ' . Auth::guard('resident')->user()->lastname}}</h4>
                    <button id="qrid-btn" class="btn btn-rose btn-sm" data-toggle="modal" type="button"
...
@endsection
@section('scripts')<script src="/js/easypiechart.js"></script>

<script>
  function reverseProfile(x) {
  ...
  reverseProfile(x) // Call listener function at run time
  x.addListener(reverseProfile) // Attach listener function on state changes
</script>
