...
<div class="content">
    <div class="container-fluid">
      <form  enctype="multipart/form-data" id="EditResidentlist" method="POST" role="form">
      <div class="row">
        <div class="col-md-8">
          <div class="card">
            <div class="card-header card-header-icon card-header-rose">
              ...
              <h4 class="card-title">Edit Residents Information -
...
<script type="text/javascript">
  ...
  $("#EditResidentlist").submit(function(e){
                  e.preventDefault();
                  ...
                  $.ajax({
                      url : "{{ route('user.resident.update') }}",
                      type : "POST",
                      data : formData,
                      async:false,
