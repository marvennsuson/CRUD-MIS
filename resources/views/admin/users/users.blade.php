...
<div class="modal fade bd-example-modal-lg" id="user_add_modal" role="dialog">
    <div class="modal-dialog modal-lg-xl" >
        <div class="wizard-container ">
            <div class="card card-wizard card-wizard-extends modal-content" data-color="rose" id="wizardProfile">
              <form enctype="multipart/form-data" class="form" id="form_user_add" data-url="{{route('admin.users.add')}}" novalidate>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-5">
      <div class="input-group form-control-lg">
          <div class="input-group-prepend">
              ...
              <div class="form-group">
                  <label for="user_group" class="bmd-label-floating">Select group</label>
                  <select class="selectpicker" title="Select a User Group"  name="user_group" id="user_group" data-style="select-with-transition">
                      <option disabled="">Select a User Group</option>
                      @foreach ($user_groups as $ug)
                          <option value="{{$ug['level'] }}">{{ $ug['user_group'] }}</option>
                      @endforeach
                  </select>
              </div>
      </div>
    ...
    <div class="input-group form-control-lg">
        <div class="input-group-prepend">
            ...
            <div class="form-group">
                ...
                <select class="selectpicker" title="Select Status"  name="Customstatus" id="Customstatus" data-style="select-with-transition">
            ...
            <div class="col-lg-10">
                ...
                <div class="card-footer ">
                  <div class="mr-auto">
                    <input type="button" class="btn btn-previous btn-fill btn-default btn-wd disabled" id="prevs" name="previous" value="Previous">
                  </div>
                  <div class="ml-auto">
...
<div class="floating-button" data-toggle="tooltip" data-placement="left" title="Create a user.">
    <button class="btn btn-rose btn-round p-3 shadow" id="btn_add_users" >
...
$( "#accounttabs" ).click(function() {
  ...
  $("#form_user_add").submit(function(e){
            ...
            $(document).on('click', "button.remove", function () {
                ...
                var action = "{{ route('admin.users.delete') }}";
               ...
               $("#user_table").dataTable({
                 "columnDefs": [{
                   ...
                   "targets": 0
                       ...
                       "autoWidth": false,
                       ajax: "{{ route('admin.users.generated') }}",
